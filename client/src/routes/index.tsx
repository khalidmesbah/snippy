...
function Home() {
      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <Button
            ...
            className="mt-4"
            onClick={() => {
              // Reset safe state and refetch via hard reload
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2">Welcome to Code Snippets</h1>
          <p className="text-muted-foreground mb-4">
            Please sign in to view and manage your code snippets
          </p>
          <Button asChild>
  ...
  return (
    <div className="px-4 py-6">
      ...
      <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            {stats.totalCount} total snippets • Showing {stats.filteredCount}
      ...
      <div className="flex justify-between items-center mb-4">
        <p className="text-sm text-muted-foreground">
          Showing {filteredSnippets.length} of {stats.totalCount} snippets
          {hasActiveFilters && " (filtered)"}
        </p>
