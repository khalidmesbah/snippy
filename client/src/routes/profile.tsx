...
import { Code2, Edit3, Globe, Mail, Save, Settings, User } from "lucide-react";
...
function ProfilePage() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">
              {(snippetsError || publicSnippetsError)?.message ||
  ...
  const publicSnippetsCount = Array.isArray(publicSnippets)
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-2xl font-bold">
                  {Array.isArray(userSnippets)
                    ? userSnippets.filter((s: Snippet) => s.is_favorite).length
                    : 0}
                </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
              <div className="space-y-0.5">
                <Label className="text-sm font-medium">
                  Show Total Snippets Count
                </Label>
                <p className="text-xs text-muted-foreground">
                  Display your total snippets count
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
              <div className="space-y-0.5">
                <Label className="text-sm font-medium">
                  Show Public Snippets Count
                </Label>
                <p className="text-xs text-muted-foreground">
                  Display your public snippets count
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
              <div className="space-y-0.5">
                <Label className="text-sm font-medium">
                  Show Public Snippets List
                </Label>
                <p className="text-xs text-muted-foreground">
                  Allow others to browse your public snippets
                </p>
              </div>
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setPrivacySettings((prev) => ({
                    ...prev,
                    showPublicSnippetsList: checked,
                  }))
                }
              />
            </div>
