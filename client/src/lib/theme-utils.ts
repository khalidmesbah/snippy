...
export const themeUtils = {
  ...
  saveTheme: (theme: Theme): void => {
    ...
    try {
      ...
      showNotification.warning("Theme preference", "Failed to save theme preference to local storage");
    }
  },
  ...
  loadTheme: (): Theme => {
    ...
    try {
      ...
      showNotification.warning("Theme preference", "Failed to load theme preference from local storage");
      return 'system'
    }
  }
}
